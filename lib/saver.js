...
var EOL, basename, dirname, normalize, relative, sep, specLocation, _ref, _ref1;

require('colors');

EOL = require('os').EOL;

_ref = require('path'), normalize = _ref.normalize, sep = _ref.sep, dirname = _ref.dirname, basename = _ref.basename, relative = _ref.relative;

_ref1 = require('path'), dirname = _ref1.dirname, basename = _ref1.basename, relative = _ref1.relative;
...
module.exports.save = function(template, name, does) {
  return does.get({
    query: {
      tag: name
    }
