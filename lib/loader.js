...
module.exports.create = function(config) {
  var api, local;
  lastInstance = local = {
    loadModules: function(arrayOfName, doesInstance) {
      var moduleName, promise;
      return promise = parallel((function() {
        var _i, _len, _results;
        _results = [];
        for (_i = 0, _len = arrayOfName.length; _i < _len; _i++) {
          moduleName = arrayOfName[_i];
    ...
    loadModulesSync: function(arrayOfName, doesInstance) {
      var moduleName, _i, _len, _results;
      _results = [];
      for (_i = 0, _len = arrayOfName.length; _i < _len; _i++) {
        moduleName = arrayOfName[_i];
        _results.push(local.loadModuleSync(moduleName, doesInstance));
      }
      return _results;
    },
    dir: config.dir,
