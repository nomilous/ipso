...
var deferred, dirname, lastInstance, lstatSync, normalize, parallel, pipeline, readdirSync, save, sep, underscore, _ref, _ref1, _ref2;
...
module.exports.create = function(config) {
  ...
  lastInstance = local = {
    ...
    recurse: function(name, path, matches) {
      var fd, file, match, stat, _i, _len, _ref3, _results;
