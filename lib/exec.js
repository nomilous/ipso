...
var actions, argsHint, bin, colors, compile, doAction, input, inspector, keypress, kid, kids, lib, lstatSync, normalize, primaryTabComplete, program, prompt, readFileSync, readdirSync, refresh, run, secondaryTabComplete, sep, shutdown, spawn, spec, src, watch, watcher, webPort, _ref, _ref1,
  __slice = [].slice;
...
_ref1 = program.parse(process.argv), inspector = _ref1.inspector, webPort = _ref1.webPort, watch = _ref1.watch, spec = _ref1.spec, src = _ref1.src, lib = _ref1.lib;
  ...
  watcher({
    ...
    handler: {
      change: function(file, stats) {
        ...
        return running.on('exit', function() {
          return refresh();
        });
      }
    }
