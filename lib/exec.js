...
var actions, argsHint, bin, colors, doAction, input, inspector, keypress, kid, kids, lstatSync, normalize, primaryTabComplete, program, prompt, readFileSync, readdirSync, refresh, run, secondaryTabComplete, sep, shutdown, spawn, watch, watcher, webPort, _ref, _ref1,
  __slice = [].slice;
...
_ref1 = program.parse(process.argv), inspector = _ref1.inspector, webPort = _ref1.webPort, watch = _ref1.watch;
