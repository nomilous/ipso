...
var actions, altEnv, argsHint, colors, compile, deferred, doAction, env, environment, input, keypress, kids, lib, lstatSync, normalize, primaryTabComplete, program, prompt, readFileSync, readdirSync, refresh, run, secondaryTabComplete, sep, shutdown, spawn, spec, src, test, watch, watcher, _ref, _ref1,
  __slice = [].slice;
