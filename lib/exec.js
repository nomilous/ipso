...
var actions, altEnv, argsHint, colors, compile, deferred, doAction, env, environment, input, inspector, keypress, kids, lib, lstatSync, normalize, primaryTabComplete, program, prompt, readFileSync, readdirSync, refresh, run, secondaryTabComplete, sep, shutdown, spawn, spec, src, test, watch, watcher, _ref, _ref1,
  __slice = [].slice;
...
_ref1 = program.parse(process.argv), env = _ref1.env, altEnv = _ref1.altEnv, watch = _ref1.watch, spec = _ref1.spec, src = _ref1.src, lib = _ref1.lib, env = _ref1.env;
...
if ((env != null) || typeof altEnv === 'string') {
  environment(altEnv);
}
